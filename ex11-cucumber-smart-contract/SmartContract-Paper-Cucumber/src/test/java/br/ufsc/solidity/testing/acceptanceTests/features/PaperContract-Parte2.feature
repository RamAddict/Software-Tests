...
Given the buyer made a solicitation on the day "15"
  And included "200" sheets of "paper" of group "6"
  And included another "500" sheets of "paper" of group "2"
When the seller delivers the paper on the day "20"
...
When the seller delivers the paper on the day "15"  
 ...
 And the buyer pays on the day "50" with a fine
Then the contract is updated and its status is "SuccessfulTermination"
